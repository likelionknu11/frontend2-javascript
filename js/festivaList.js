const festivalContents = [
  //카드 이미지 hover했을 때 나올 카드 내용
  {
    ...
    festivalMainIns:
      "아름다운 봄, 벚꽃이야기 호수벚꽃축제'는 코로나로 인해 4년만에 열리는 벚꽃과 석촌호수의 자연환경이 어우러진 축제이다. 4월 5일 석촌호수 동호 중앙무대에서 개막식 공연과 함께 축제의 시작을 알리며, 이후로는 청년 버스킹 및 문화예술단체 등이 준비한 각종 공연이 진행된다. 또한 캐리커쳐, 페이스페인팅 등 각종 체험부스와 플리마켓이 준비되어 있어 관람객들에게 볼거리와 놀거리를 다양하게 제공한다. 올해 가족 및 친구, 연인 등과 함께 따뜻한 햇살과 만개한 벚꽃이 경관을 이루는 석촌호수에서 봄의 향연을 즐기시기 바란다.", //축제 설명
  ...
  },
  {
    ...
    festivalMainIns:
      "서울릴랙스위크는 국내외의 유수한 연사들의 강연으로 꾸려지는 '담마토크'와, 매주 일상 속에서 지혜로운 삶을 위해 마음을 공부하는 '수행주간', 누구나 방문하여 몸과 마음을 돌볼 수 있는 '마음이 쉬는 곳'으로 구성되어 있는 서울 도시 축제이자, 멘탈 힐링 축제이다. 시민들의 힐링, 치유, 마음 관리를 위한 마음챙김 관련 프로그램을 제공하는 연구·교육 기관·단체·협회 108곳을 모아 지도로 제작해, 모두가 편히 쉴 수 있는 릴랙스 스팟을 한눈에 보여드린다. 명상을 통한 시민들의 스트레스 완화와 치유, 행복을 도모하는 담마토크 및 수행주간 등 시민참여형 프로그램으로 일상 속 소소하고 편안한 휴식을 제공한다.", //축제 설명
